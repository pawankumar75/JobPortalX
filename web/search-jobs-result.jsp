<%-- 
    Document   : search-jobs-result.jsp
    Created on : 08-Sept-2024, 10:11:55 pm
    Author     : pawan kumar
--%>
...
<jsp:scriptlet>
   ...
   String technology2 = request.getParameter("technolgy1");
                                        ...
                                        <jsp:scriptlet>
                                            ...
                                            try
                                           
                                             {
                                               ...
                                               PreparedStatement ps=con.prepareStatement("select*from jobs where job_profile='%"+technology2+"%' OR job_location LIKE'%"+location2+"%'");

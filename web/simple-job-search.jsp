<%-- 
    ...
    Created on : 08-Sept-2024, 11:02:11 am
    Author     : pawan kumar
--%>
            ...
            <jsp:include page="menubar.jsp"></jsp:include>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 job_search_div">
                        ...
                        <input type="text" placeholder="Job search by Technology" class="textfield_design" onkeyup="searchJobByTech(this.value)" /> <br> <br>
                        OR <br> <br>
                        <input type="text" placeholder="Job search by Location" class="textfield_design" onkeyup="searchJobByLocation(this.value)" /> <br> <br>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                <!-- ==============search job div ends================= -->
